...
Version  : 6.2.0
Release  : 124
URL      : https://download.kde.org/stable/plasma/6.2.0/plasma-desktop-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.0/plasma-desktop-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/plasma-desktop-6.2.0.tar.xz.sig
...
%setup -q -n plasma-desktop-6.2.0
cd %{_builddir}/plasma-desktop-6.2.0
pushd ..
cp -a plasma-desktop-6.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728859753
mkdir -p clr-build
pushd clr-build
