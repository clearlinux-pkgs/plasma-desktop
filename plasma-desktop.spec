...
Version  : 6.2.4
Release  : 125
URL      : https://download.kde.org/stable/plasma/6.2.4/plasma-desktop-6.2.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.4/plasma-desktop-6.2.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.4/plasma-desktop-6.2.4.tar.xz.sig
...
%setup -q -n plasma-desktop-6.2.4
cd %{_builddir}/plasma-desktop-6.2.4
pushd ..
cp -a plasma-desktop-6.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735394842
mkdir -p clr-build
pushd clr-build
...
/usr/share/kcm_recentFiles/workspace/settings/qml/recentFiles/BlacklistApplicationView.qml
...
/usr/share/knotifications6/kcm_touchpad.notifyrc
