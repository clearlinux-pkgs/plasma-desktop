...
Version  : 6.1.3
Release  : 119
URL      : https://download.kde.org/stable/plasma/6.1.3/plasma-desktop-6.1.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.3/plasma-desktop-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/plasma-desktop-6.1.3.tar.xz.sig
...
%setup -q -n plasma-desktop-6.1.3
cd %{_builddir}/plasma-desktop-6.1.3
pushd ..
cp -a plasma-desktop-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721172086
mkdir -p clr-build
pushd clr-build
