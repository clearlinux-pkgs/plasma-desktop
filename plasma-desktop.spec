...
Version  : 6.3.4
Release  : 133
URL      : https://download.kde.org/stable/plasma/6.3.4/plasma-desktop-6.3.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.4/plasma-desktop-6.3.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.4/plasma-desktop-6.3.4.tar.xz.sig
...
%setup -q -n plasma-desktop-6.3.4
cd %{_builddir}/plasma-desktop-6.3.4
pushd ..
cp -a plasma-desktop-6.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744157576
mkdir -p clr-build
pushd clr-build
