...
Source0  : https://download.kde.org/stable/plasma/5.17.2/plasma-desktop-5.17.2.tar.xz
Source1 : https://download.kde.org/stable/plasma/5.17.2/plasma-desktop-5.17.2.tar.xz.sig
...
%prep
%setup -q -n plasma-desktop-5.17.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572450508
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/plasma-desktop-5.17.2/COPYING %{buildroot}/usr/share/package-licenses/plasma-desktop/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/plasma-desktop-5.17.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/plasma-desktop/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/plasma-desktop-5.17.2/COPYING.LGPL-2 %{buildroot}/usr/share/package-licenses/plasma-desktop/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/plasma-desktop-5.17.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/plasma-desktop/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/plasma-desktop-5.17.2/applets/kimpanel/COPYING %{buildroot}/usr/share/package-licenses/plasma-desktop/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/plasma-desktop-5.17.2/applets/kimpanel/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/plasma-desktop/57c3cb6b9aee09ae2af06b0c517e2969d2f33d47
cp %{_builddir}/plasma-desktop-5.17.2/applets/kimpanel/COPYING.LIB %{buildroot}/usr/share/package-licenses/plasma-desktop/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/plasma-desktop-5.17.2/applets/kimpanel/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/plasma-desktop/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/plasma-desktop-5.17.2/kcms/kfontinst/viewpart/COPYING.UNICODE %{buildroot}/usr/share/package-licenses/plasma-desktop/ae855f68ab20f57b2cc7e9b03f54a87563424eb9
cp %{_builddir}/plasma-desktop-5.17.2/kcms/touchpad/COPYING %{buildroot}/usr/share/package-licenses/plasma-desktop/8b24e55e650d5d13ae3b1a2162a70b5238400aed
cp %{_builddir}/plasma-desktop-5.17.2/solid-device-automounter/COPYING %{buildroot}/usr/share/package-licenses/plasma-desktop/7c203dee3a03037da436df03c4b25b659c073976
pushd clr-build
%make_install
popd
%find_lang kaccess
...
/usr/lib64/libkfontinst.so.5.17.2
/usr/lib64/libkfontinstui.so.5
/usr/lib64/libkfontinstui.so.5.17.2
