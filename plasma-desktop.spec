...
Version  : 5.14.1
Release  : 13
URL      : https://download.kde.org/stable/plasma/5.14.1/plasma-desktop-5.14.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.1/plasma-desktop-5.14.1.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.1/plasma-desktop-5.14.1.tar.xz.sig
...
%prep
%setup -q -n plasma-desktop-5.14.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1539733037
mkdir -p clr-build
pushd clr-build
%cmake ..
...
/usr/lib64/libkfontinst.so.5.14.1
/usr/lib64/libkfontinstui.so.5
/usr/lib64/libkfontinstui.so.5.14.1
